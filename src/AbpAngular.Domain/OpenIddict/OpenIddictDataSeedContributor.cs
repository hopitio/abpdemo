...
namespace AbpAngular.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpAngular") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpAngular", DisplayName = "AbpAngular API", Resources = { "AbpAngular" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["AbpAngular_App:RootUrl"]?.TrimEnd('/');
