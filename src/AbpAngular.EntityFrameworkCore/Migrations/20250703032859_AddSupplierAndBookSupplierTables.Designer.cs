...
namespace AbpAngular.Migrations
{
    ...
    [Migration("20250703032859_AddSupplierAndBookSupplierTables")]
    partial class AddSupplierAndBookSupplierTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpAngular.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AbpAngular.Suppliers.BookSupplier", b =>
                {
                    ...
                    b.ToTable("AppBookSuppliers", (string)null);
                });

            modelBuilder.Entity("AbpAngular.Suppliers.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AbpAngular.Suppliers.BookSupplier", b =>
                {
                    b.HasOne("AbpAngular.Books.Book", "Book")
                        .WithMany("BookSuppliers")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AbpAngular.Suppliers.Supplier", "Supplier")
                        .WithMany("BookSuppliers")
